...
namespace Negocio
{
    public class N_Users
    {
        ...
        public int N_registrar_consulta(string consulta, int id)
        {
        ...
        public DataTable N_ConsultasUser(int id)
        {
        ...
        public DataTable N_GetSuscripciones(int id)
        {
        ...
        public int N_SuscribirseLinea(int id, int linea)
        {
        ...
        {
            return usuarios.editEmp(obje);
        }

        public int editUserNF(Usuarios obje)
        {
            return usuarios.editUser(obje);
        }

        public DataSet Cargar()
        {
            UsuariosData oAcceso = new UsuariosData();
            return oAcceso.Leer();
        }

        public void Agregar(DataSet Ds)
        {
            UsuariosData oAcceso = new UsuariosData();
            oAcceso.Cargar(Ds);
        }
