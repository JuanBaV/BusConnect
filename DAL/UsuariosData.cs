...
namespace DAL
{
    public class UsuariosData
    {
        ...
        public int Empresa_register(Usuarios obje)
        {
            ...
            cmd.Parameters.AddWithValue("@cod", obje.cod);
            return check(cmd);
        }

        //envio de consultas
        public int Consultas_register(string consulta, int id)
        {
            cn.Open();
        ...
        public DataTable getSuscripciones(int id)
        {
            SqlCommand cmd = new SqlCommand("select * from suscripciones where Cod_Usuario=@id ", cn);
            cmd.Parameters.AddWithValue("@id", id);
            SqlDataAdapter adapter = new SqlDataAdapter(cmd);
            DataTable dataTable = new DataTable();
            adapter.Fill(dataTable);
        ...
        public DataTable getConsultasUser(int id)
        {
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * from Usuarios where Role!=3 ", cn);
            SqlDataAdapter adapter = new SqlDataAdapter(cmd);
            DataTable dataTable = new DataTable();
            adapter.Fill(dataTable);
            return dataTable;
        ...
        public int SuscribirseLinea(int id, int linea)
        {
            cn.Open();
        ...
        public int PASSUpdateAdmin(Usuarios obje)
        {
            ...
            cmd.Parameters.AddWithValue("@imagen", obje.imagen);
            return check(cmd);
        }
        public int editUser(Usuarios obje)
        {
            cn.Open();
            SqlCommand cmd = new SqlCommand("edituserNF", cn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Cod", obje.cod);
            cmd.Parameters.AddWithValue("@ID", obje.ID);
            cmd.Parameters.AddWithValue("@pass", obje.Contraseña);
        ...
        public int editEmp(Usuarios obje)
        {
            cn.Open();
            SqlCommand cmd = new SqlCommand("editEmp", cn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@cod", obje.cod);
            cmd.Parameters.AddWithValue("@id", obje.ID);
            cmd.Parameters.AddWithValue("@pass", obje.Contraseña);
        ...
        public DataSet Leer()
        {
            ...
            SqlDataAdapter Da = new SqlDataAdapter("Select * from Usuarios where Role!=3 ", cn);
            Da.Fill(Ds);
            Cerrar();
            return Ds;
        }

        public void Cargar(DataSet Ds)
        {
            cn.Open();
            SqlDataAdapter Da = new SqlDataAdapter("Select * from Usuarios where Role!=3 ", cn);
